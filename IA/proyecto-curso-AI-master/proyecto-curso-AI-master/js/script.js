...
function preload (){
    ...
    audio3 = createAudio (`assets/riff.mp3`)
}
function setup() {
...
function draw() {
    ...
    image(img2,posXPala,posYPala, wPala, hPala, zPala); 
    ...
    if(posYBola == posYPala && (posXBola >=posXPala && posXBola <= posXPala+wPala)){
        vyBola = vyBola * -1;
    }
...
function keydown() {
    ...
    } else if (keyIsDown (39) && posXPala < (1280-wPala)) {
      posXPala=posXPala+vxPala;
    }
    if (keyIsDown (32) ){
